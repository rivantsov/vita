...
namespace Vita.Data.Driver {
  ...
  public partial class DbModelLoader {
    ...
    public virtual DataTable GetSchemas() {
...
ORDER BY TABLE_SCHEMA, TABLE_NAME;";
      ...
      dt.Columns.Add("IS_MATERIALIZED", typeof(string));
      return dt; 
    }
  ...
  ORDER BY TABLE_SCHEMA, TABLE_NAME, ORDINAL_POSITION;", filter);
    ...
    public virtual DataTable GetTableConstraints() {
    ...
    public virtual DataTable GetTableConstraintColumns() {
      var filter = GetSchemaFilter("TABLE_SCHEMA");
...
", filter);
    ...
    public virtual DataTable GetReferentialConstraints() {
      var filter = GetSchemaFilter("CONSTRAINT_SCHEMA");
  ...
  WHERE {0}", filter);
    ...
    public virtual DataTable GetReferentialConstraintsExt() {
...
WHERE {0};", filter);
    ...
    public virtual DataTable GetRoutines() {
  ...
  SELECT ROUTINE_SCHEMA, ROUTINE_NAME, ROUTINE_DEFINITION, ROUTINE_TYPE, NULL AS ROUTINE_CUSTOM 
    ...
    public virtual DataTable GetSequences() {
      const string template = @"
  SELECT SEQUENCE_SCHEMA, SEQUENCE_NAME, DATA_TYPE, NUMERIC_PRECISION, NUMERIC_SCALE, START_VALUE, INCREMENT 
    ...
    public virtual DataTable GetUserDefinedTypes() {
      return EmptyTable; 
    }
