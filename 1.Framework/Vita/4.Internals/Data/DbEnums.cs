...
namespace Vita.Data {
  ...
  public enum DbUpgradeOptions {
    ...
    // UpdateStoredProcs = 1 << 2, //deprecated
    ...
    Default = UpdateTables | UpdateIndexes | UpdateViews,
  }
  ...
  [Flags]
  public enum DbConnectionFlags {
    None = 0,
    CommitOnSave = 1,
  }

  public enum DbConnectionLifetime {
    Operation,
    Transaction,
    Explicit,
