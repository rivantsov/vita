...
namespace Vita.Data.Linq {
  ...
  public class LinqCommandAnalyzer {
    ...
    enum ValueKind {
      ...
      Input,  // local value; parameter, not part of query definition
      Db, // identifies data record value (or derived from it)
    }

    public static void Analyze(EntityModel model, LinqCommand command) {
