...
namespace Vita.Samples.BookStore.UI
{
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Vita.Samples.Bookstore");
                        ...
                        c.IgnoreObsoleteActions(); // Vita sample: uncommented this
                      ...
                      //
                      c.GroupActionsBy(apiDesc => apiDesc.ActionDescriptor.GetSwaggerApiGroup());
    ...
    class SlimApiOperationFilter : IOperationFilter {
      public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription) {
        operation.operationId = apiDescription.ActionDescriptor.GetSwaggerOperationId();
      }
    }
  }//class
}
