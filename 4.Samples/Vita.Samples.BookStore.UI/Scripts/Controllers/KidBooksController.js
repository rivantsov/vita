...
//------------------------------------------------------------------------------
/// <summary>This controller provides Kid books.</summary>
//------------------------------------------------------------------------------
var KidBooksController = function($scope, $stateParams, $state, $window, $location, BooksService) {
    ...
    $scope.search = function () {
      var result = BooksService.searchBooks(null, "Kids", null, null, null, null, null, $scope.searchQuery.orderBy, $scope.searchQuery.descending, $scope.searchQuery.page, $scope.searchQuery.pageSize);
...
KidBooksController.$inject = ['$scope', '$stateParams', '$state', '$window', '$location', 'BooksService'];