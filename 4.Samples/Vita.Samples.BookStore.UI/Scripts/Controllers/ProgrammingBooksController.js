...
//------------------------------------------------------------------------------
/// <summary>This controller provides Programming books.</summary>
//------------------------------------------------------------------------------
var ProgrammingBooksController = function ($scope, $stateParams, $state, $window, $location, BooksService) {
    ...
    $scope.search = function () {
      var result = BooksService.searchBooks(null, "Programming", null, null, null, null, null, $scope.searchQuery.orderBy, $scope.searchQuery.descending, $scope.searchQuery.page, $scope.searchQuery.pageSize);
...
ProgrammingBooksController.$inject = ['$scope', '$stateParams', '$state', '$window', '$location', 'BooksService'];