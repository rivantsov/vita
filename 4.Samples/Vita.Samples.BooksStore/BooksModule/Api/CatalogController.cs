...
namespace Vita.Samples.BookStore.Api {
  ...
  public class CatalogController : SlimApiController {

    public CatalogController() { }

    // Constructor to be used outside Web server context, in extended unit tests project, LinqSearchTest
    public CatalogController(OperationContext context) {
    ...
    public Stream GetImage(Guid id) {
      //Do not log body
      Context.LogLevel = Entities.Services.LogLevel.None; //do not log this call
