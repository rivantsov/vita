...
namespace Vita.Entities {
  ...
  public partial class EntityModule {
    ...
    public void RegisterSequence(string name, Type type = null, int startValue = 0, int increment = 1) {
      type = type ?? typeof(long); 
      var sequence = new SequenceDefinition(this, name, type, startValue, increment);
